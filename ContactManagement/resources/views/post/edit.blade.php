                ...
                <div class="card-body">
                    <form action="{{route('posts.update', $post->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('title') ? old('title') : $post->title}}" class="form-control" id="title" name="title" placeholder="Enter Title" name="title">
                            @if($errors->any('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" id="image"  placeholder="Choose an image" name="">
                            @if($errors->any('image'))
